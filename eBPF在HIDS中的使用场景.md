...
## 一、 eBPF历史
 ...
 2. 前身BPF出现，解决什么问题。
    ...
    ![udohbd0u3x](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/udohbd0u3x-1696044.png)
 ...
 3. eBPF出现背景，为了解决什么问题
    ...
    ![1334952-20200806131434176-1093013946](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/1334952-20200806131434176-1093013946-1696275.png)
    ...
    ![loader-7eec5ccd8f6fbaf055256da4910acd5a](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/loader-7eec5ccd8f6fbaf055256da4910acd5a-1696456.png)
 ...
 4. eBPF发展到现在的关键路标
    ...
    ![image-20210522230951641](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/image-20210522230951641.png)
...
## 二、eBPF基础
 ...
 1. eBPF能干啥
    ...
    ![image-20210522232638156](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/image-20210522232638156.png)

    <img src="/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/image-20210522232711532.png" alt="image-20210522232711532" style="zoom:67%;" />

 2. eBPF怎么用（工具、编码）

    早期BPF代码需要使用伪机器码编写对内核网络报文的处理代码，然后用socket将代码加载到内核。

    ![image-20210522233733622](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/image-20210522233733622.png)

    eBPF可使用C语言编写内核处理代码，通过llvm编译后，使用linux提供的一些帮助函数helper，最终通过syscall将编译后的伪机器码加载到内核。

    ![libbpf-f4991ee40f74df260dbb3e0541855044](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/libbpf-f4991ee40f74df260dbb3e0541855044.png)

    

    bcc之类的工具提供了更进一步的简化，减少了手动操作步骤：

    ![bcc-def942c66b8c7565f0cfeab1c1017a80](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/bcc-def942c66b8c7565f0cfeab1c1017a80.png)
...
## 三、eBPF在安全监控上的应用
 ...
 1. 简单使用介绍
    ...
    ![dfyjrg8q4abkcjgcsnp00vuuymg](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/dfyjrg8q4abkcjgcsnp00vuuymg.jpeg)

    简单使用演示：

    ![eBPF使用演示](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/eBPF使用演示.gif)
 ...
 3. 监控文件访问
    ...
    ​	![readfile_cpuall](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/readfile_cpuall.png)
...
​	![process_cpuall](/Users/simon/Library/Mobile Documents/com~apple~CloudDocs/Documents/eBPF在HIDS中的使用场景.assets/process_cpuall.png)
